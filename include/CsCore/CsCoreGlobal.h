...
enum CS_CORE_CLASSCODE
{
	...
	CORE_CLASSCODE_UCHARACTER,			// UCharacter
	CORE_CLASSCODE_WCHARACTER,			// WCharacter
	CORE_CLASSCODE_SHORT,				// Short
	CORE_CLASSCODE_USHORT,				// UShort
	CORE_CLASSCODE_INTEGER,				// Integer
	CORE_CLASSCODE_UINTEGER,			// UInteger
	CORE_CLASSCODE_LONG,				// Long
	CORE_CLASSCODE_ULONG,				// ULong
	CORE_CLASSCODE_LONGLONG,			// LongLong
	CORE_CLASSCODE_ULONGLONG,			// ULongLong
	CORE_CLASSCODE_FLOAT,				// Float
	CORE_CLASSCODE_DOUBLE,				// Double
	CORE_CLASSCODE_DECIMAL,				// Decimal

	
	CORE_CLASSCODE_NUMBER,			// Int8
