...
public:
	struct CsOrderSetNode
		: public GBinaryTreeNodeT<CsOrderSetNode>
		, public GPairNodeT<KeyT, GDummyNodeT>
		, public GNewT<CsOrderSetNode>
	{
		gsmall m_nColor;
		...
		CsOrderSetNode(
			...
			: GBinaryTreeNodeT<CsOrderSetNode>(parent, left, right)
...
private:
	GReadBlackTree<KeyT, GDummyNodeT, CompareT, CsOrderSetNode> m_tTree;
	gsize m_nSize;
};
