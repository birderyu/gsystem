...
#define G_SMALL_STRING_MAX_SIZE		8
...
public:
	static const gsize MAX_SIZE = G_SMALL_STRING_MAX_SIZE - 1;
	static const gsize NULL_POS = G_SMALL_STRING_MAX_SIZE;
...
private:
	guint8 m_nSize;
	gchar m_cStr[G_SMALL_STRING_MAX_SIZE];
};
