...
public:
	...
	****************************************************************************/
	...
	public:
		// 满足条件，并向左侧追踪（011）
		static const gbyte FIT_AND_TURN_LEFT			= FIT | TURN_LEFT;

		// 满足条件，并向右侧追踪（101）
		static const gbyte FIT_AND_TURN_RIGHT			= FIT | TURN_RIGHT;

		// 满足条件，并向两个方向追踪（111）
		static const gbyte FIT_AND_TURN_BOTH_SIDE		= FIT | TURN_LEFT | TURN_RIGHT;

		// 满足条件，并停止追踪（001）
		static const gbyte FIT_AND_STOP					= FIT;

		// 不满足条件，并向左侧追踪（010）
		static const gbyte NO_FIT_AND_TURN_LEFT			= NO_FIT | TURN_LEFT;

		// 不满足条件，并向右侧追踪（100）
		static const gbyte NO_FIT_AND_TURN_RIGHT		= NO_FIT | TURN_RIGHT;

		// 不满足条件，并向两个方向追踪（110）
		static const gbyte NO_FIT_AND_TURN_BOTH_SIDE	= NO_FIT | TURN_LEFT | TURN_RIGHT;

		// 不满足条件，并停止追踪（000）
		static const gbyte NO_FIT_AND_STOP				= NO_FIT;
...
public:
	...
	template<typename FilterT> Nodes Search(const FilterT &filter);
	template<typename FilterT> ConstNodes Search(const FilterT &filter) const;
