...
GINLINE 
typename GBSTree<KeyT, ValueT, CompareT, NodeT>::Nodes 
GBSTree<KeyT, ValueT, CompareT, NodeT>::Search(const FilterT &filter)
{
	Nodes nodes;
...
template<typename FilterT> 
GINLINE 
typename GBSTree<KeyT, ValueT, CompareT, NodeT>::ConstNodes 
GBSTree<KeyT, ValueT, CompareT, NodeT>::Search(const FilterT &filter) const
{
	ConstNodes nodes;
	Search_Recursive(m_pRoot, filter, nodes);
	return nodes;
